...
gulp.task('scripts', () =>
  ...
  gulp.src([
    'src/assets/javascript/jquery-1.11.2.min.js',
    'src/assets/javascript/jquery.easing.1.3.js',
    'src/assets/javascript/bootstrap.min.js',
    'src/assets/javascript/SmoothScroll.js',
    'src/assets/javascript/jquery.scrollTo.min.js',
    'src/assets/javascript/jquery.localScroll.min.js',
    'src/assets/javascript/jquery.viewport.mini.js',
    'src/assets/javascript/jquery.countTo.js',
    'src/assets/javascript/jquery.appear.js',
    'src/assets/javascript/jquery.sticky.js',
    ...
    'src/assets/javascript/wow.min.js',
    'src/assets/javascript/masonry.pkgd.min.js',
    'src/assets/javascript/jquery.simple-text-rotator.min.js',
    'src/assets/javascript/all.js',
    'src/assets/javascript/contact-form.js',
    'src/assets/javascript/jquery.ajaxchimp.min.js',
    'src/assets/javascript/jquery.backgroundvideo.min.js'
  ])
